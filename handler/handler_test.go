...
func TestInsert(t *testing.T) {
	...
	t.Run("Should Failed Insert", func(t *testing.T) {
		mock := new(usecase.FootballUsecaseMock)
		handlers := NewFootballClubHandler(mock)
		...
		mock.On("Insert", footballClub).Return(model.FootballClub{}, errors.New("Error on inserting data"))
